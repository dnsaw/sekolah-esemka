...
$edig = query("SELECT * FROM guru WHERE id = $id")[0];

if (isset($_POST["beditg"])) {
      ...
      <div class="modal-content">
        ...
        <form action="" method="post" data-aos="fade-up" delay="20000">
          <div class="modal-header">
            ...
            <a href="guru.php"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></a>
          </div>
          <div class="modal-body">
            <input type="hidden" name="id" class="form-control" id="id" required value="<?php echo $edig["id"]; ?>">
            <div class="mb-3">
              <label for="nama">Nama<span class="text-danger">*</span></label>
              <input type="text" name="nama" class="form-control" id="nama" required value="<?php echo $edig["nama"]; ?>">
            </div>

            <div class=" mb-3">
              <label for="nis">NIG<span class="text-danger">*</span></label>
              <input type="number" name="nig" class="form-control" id="nis" required value="<?php echo $edig["nig"]; ?>">
            </div>


            <label for="tempatlahir">Tempat tanggal Lahir<span class="text-danger">*</span></label>
            <div class=" mb-3 d-flex">
              <input type="text" name="tempatlahir" class="form-control" id="tempatlahir" required value="<?php echo $edig["tempatlahir"]; ?>">
              <input type="date" name="tgl_lahir" class="form-control" id="tgl_lahir" required value="<?php echo $edig["tgl_lahir"]; ?>">
            </div>

            <div class=" mb-3">
              <label for="jeniskelamin">Jenis Kelamin<span class="text-danger">*</span></label>
              <div class="form-label-group">
                <select class="form-control" name="jeniskelamin" required value="<?php echo $edig["jeniskelamin"]; ?>">
            ...
            <div class=" mb-3">
              ...
              <div class="form-label-group">
                <select class="form-control" name="agama" required value="<?php echo $edig["agama"]; ?>">
            ...
            <div class="mb-3">
              ...
              <input type="alamat" name="alamat" class="form-control" id="alamat" required value="<?php echo $edig["alamat"]; ?>">
            </div>
          </div>
          <div class=" modal-footer pt-4">
            <button type="submit" name="beditg" class="btn btn-primary mx-auto w-100">Edit Guru</button>
          </div>
        </form>
      </div>
    </div>
