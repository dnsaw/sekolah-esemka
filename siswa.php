      ...
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            ...
            <div class="col-sm-4">
              <button type="button" class="btn btn-info add-new" data-bs-toggle="modal" data-bs-target="#addsiswa"><i class="bi bi-plus-circle-fill"></i> Add Siswa</button>
            </div>
          </div>
        </div>
            ...
            <?php while ($row = mysqli_fetch_array($siswa)) : ?>
              <tr class="text-center">
                ...
                <td>
                  ...
                  <a class="edit" title="Edit" name="edit" data-bs-toggle="modal" href="../sekolah esemka project/siswaedit.php?id=<?= $row["id"]; ?>"><i class="bi bi-pencil-square"></i></a>
                  <a class="delete" title="Delete" name="delete" data-toggle="tooltip" href="siswadelete.php?hal=<?= $row["id"]; ?>" onclick="return confirm('Yakin Menghapus data siswa tersebut?');"><i class="bi bi-trash3"></i></a>
                </td>
              </tr>
            <?php endwhile; ?>
          </tbody>
        ...
        <form action="siswa.php" method="post">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <input type="text" name="nama" class="form-control" id="nama" placeholder="Input Nama Siswa" required>
            </div>

            <div class="mb-3">
              <label for="nis">NIS<span class="text-danger">*</span></label>
              <input type="number" name="nis" class="form-control" id="nis" placeholder="Input NIS" required>
            </div>

            <label for="tempatlahir">Tempat tanggal Lahir<span class="text-danger">*</span></label>
            <div class="mb-3 d-flex">
              <input type="text" name="tempatlahir" class="form-control" id="tempatlahir" placeholder="Input Tempat lahir Siswa" required>
              <input type="date" name="tgl_lahir" class="form-control" id="tgl_lahir" placeholder="Input Tanggal lahir Siswa" required>
            </div>

            <div class="mb-3">
              <label for="jeniskelamin">Jenis Kelamin<span class="text-danger">*</span></label>
              <select class="form-control" name="jeniskelamin" required>
                <option value="None">Pilih gender Siswa</option>
            ...
            <div class="mb-3">
              ...
              <div class="form-label-group">
                <select class="form-control" name="agama" required>
                  <option value="None">Pilih agama Siswa</option>
            ...
            <div class="mb-3">
              ...
              <textarea type="text-area" name="alamat" class="form-control" id="alamat" placeholder="Input Alamat Siswa" required></textarea>
            </div>
          </div>
          <div class="modal-footer pt-4">
            <button type="submit" name="add-siswa" class="btn btn-primary mx-auto w-100">Tambah data siswa</button>
          </div>
        </form>
      </div>
    </div>
